...
"#))
    ...
    fn test_fragments() {
        ...
        let expected_successes = vec![
            ...
            "fixtures/fragments/file1.md#escaped-attribute",
            ...
            "fixtures/fragments/file1.md#literal-code-attribute",
            "fixtures/fragments/file1.md#review-across-lines-heading",
            "fixtures/fragments/file1.md#review-between-empty-heading",
            "fixtures/fragments/file1.md#review-blank-line",
            "fixtures/fragments/file1.md#review-code-block-heading",
            "fixtures/fragments/file1.md#review-double-spaced-heading",
            "fixtures/fragments/file1.md#review-double-tight-heading",
            "fixtures/fragments/file1.md#review-emphasis-heading",
            "fixtures/fragments/file1.md#review-line-before-heading",
            "fixtures/fragments/file1.md#review-multiple-first",
            "fixtures/fragments/file1.md#review-multiple-groups-heading",
            "fixtures/fragments/file1.md#review-quote",
            "fixtures/fragments/file1.md#review-spaces",
            "fixtures/fragments/file1.md#review-text-after-heading",
            "fixtures/fragments/file1.md#review-text-before-heading",
            "fixtures/fragments/file1.md#setext-h1-id",
            "fixtures/fragments/file1.md#setext-h2-id",
            "fixtures/fragments/file1.md#setext-level-one",
            "fixtures/fragments/file1.md#setext-level-two",
        ...
        let expected_errors = vec![
            ...
            "fixtures/fragments/file1.md#code-attribute-id",
            "fixtures/fragments/file1.md#escaped-attribute-id",
            "fixtures/fragments/file1.md#review-across-lines",
            "fixtures/fragments/file1.md#review-between-empty",
            "fixtures/fragments/file1.md#review-code-block",
            "fixtures/fragments/file1.md#review-double-spaced",
            "fixtures/fragments/file1.md#review-double-tight",
            "fixtures/fragments/file1.md#review-emphasis",
            "fixtures/fragments/file1.md#review-line-before",
            "fixtures/fragments/file1.md#review-multiple-second",
            "fixtures/fragments/file1.md#review-text-after",
            "fixtures/fragments/file1.md#review-text-before",
...
"#,
    ...
    /// Verify that a `github.com/owner/repo#readme` link is checked via the
    /// GitHub API and reported as valid when the API returns 200. The
    /// `--remap` flag redirects `api.github.com` to the mock server so the
    /// test is fully self-contained. The mock also asserts that lychee sends
    /// an `Authorization: Bearer` header, confirming token injection works
    /// end-to-end through the quirk and chain pipeline.
    #[tokio::test]
